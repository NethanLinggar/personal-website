            ...
            >
              ...
              <div className="mb-6">
                <a
                  ...
                  className="inline-flex items-center gap-1.5 rounded-full border border-white/10 bg-black/20 px-3 py-1.5 text-sm text-white/80 transition-colors hover:bg-black/30 hover:text-white"
                >
                  View on GitHub
