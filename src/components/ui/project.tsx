...
export default function Project({
  ...
  return (
    ...
    >
      <section className="relative max-w-[62rem] overflow-visible rounded-lg transition-colors sm:h-[20rem] sm:pr-8">
        <div className="absolute inset-0 rounded-lg border border-white/5 bg-light-gray/20 transition-colors group-hover:bg-light-gray/10 dark:border-white/5 dark:bg-white/10 dark:group-hover:bg-white/20 sm:top-8"></div>
        ...
        <div className="absolute bottom-0 right-0 top-0 hidden w-1/2 overflow-hidden group-even:left-0 group-even:right-[initial] sm:block">
          <Image
            ...
            quality={75}
            className="absolute left-1/2 top-5 w-[75%] min-w-[300px] -translate-x-1/2 transition-transform group-hover:-translate-y-2 group-hover:scale-105"
          />
        </div>
      </section>
    </motion.div>
