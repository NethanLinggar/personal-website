  ...
  return (
    <Dialog open={isOpen} onClose={onClose} className="relative z-50">
      ...
      <div className="fixed inset-0 flex items-end justify-center sm:items-start sm:p-4 sm:pt-24">
        <DialogPanel className="w-full max-w-4xl transform overflow-hidden rounded-t-2xl bg-white shadow-xl transition-all dark:bg-light-gray sm:max-h-[calc(100vh-5rem)] sm:rounded-2xl">
          {/* Header */}
          ...
          {/* Content */}
          <div
            className="modal-content max-h-[75vh] overflow-y-auto px-6 py-6 pb-28 sm:max-h-[calc(100vh-13rem)] sm:pb-6"
            style={
              {
                scrollbarWidth: "thin",
